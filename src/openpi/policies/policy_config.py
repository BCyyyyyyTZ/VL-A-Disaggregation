...
def create_trained_policy(
    ...
    *,
    ...
    Args:
        ...
        enable_component_timing: Whether baseline policy may split VLM/AE for component timing.
            Disable to keep the full sample_actions compiled/jitted graph intact.
