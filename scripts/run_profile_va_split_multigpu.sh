...
MAX_PREFIX_ADMITS_PER_DRAIN="${MAX_PREFIX_ADMITS_PER_DRAIN:-1}"
...
cmd=(
  ...
  --max-prefix-admits-per-drain "${MAX_PREFIX_ADMITS_PER_DRAIN}"
...
echo "  batch:  max_vlm=${MAX_VLM_BATCH_SIZE} max_ae=${MAX_AE_BATCH_SIZE} max_vlm_wait_ms=${MAX_VLM_WAIT_MS} max_prefix_admits_per_drain=${MAX_PREFIX_ADMITS_PER_DRAIN}"
