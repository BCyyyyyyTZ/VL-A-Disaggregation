...
def summarize_traces(
    ...
    *,
    ...
    summary: dict[str, float | int | None] = {
        ...
        "policy_input_stage_mean_ms": _timing_mean(completed, "policy_input_stage_ms"),
        "policy_input_stage_p50_ms": _timing_percentile(completed, "policy_input_stage_ms", 50),
        "policy_input_stage_p95_ms": _timing_percentile(completed, "policy_input_stage_ms", 95),
        "policy_input_transform_mean_ms": _timing_mean(completed, "policy_input_transform_ms"),
        "policy_input_transform_p50_ms": _timing_percentile(completed, "policy_input_transform_ms", 50),
        "policy_input_transform_p95_ms": _timing_percentile(completed, "policy_input_transform_ms", 95),
        "policy_input_batch_stage_mean_ms": _timing_mean(completed, "policy_input_batch_stage_ms"),
        "policy_input_batch_stage_p50_ms": _timing_percentile(completed, "policy_input_batch_stage_ms", 50),
        "policy_input_batch_stage_p95_ms": _timing_percentile(completed, "policy_input_batch_stage_ms", 95),
        "policy_sample_kwargs_stage_mean_ms": _timing_mean(completed, "policy_sample_kwargs_stage_ms"),
        "policy_sample_kwargs_stage_p50_ms": _timing_percentile(completed, "policy_sample_kwargs_stage_ms", 50),
        "policy_sample_kwargs_stage_p95_ms": _timing_percentile(completed, "policy_sample_kwargs_stage_ms", 95),
        "policy_observation_from_dict_mean_ms": _timing_mean(completed, "policy_observation_from_dict_ms"),
        "policy_observation_from_dict_p50_ms": _timing_percentile(completed, "policy_observation_from_dict_ms", 50),
        "policy_observation_from_dict_p95_ms": _timing_percentile(completed, "policy_observation_from_dict_ms", 95),
